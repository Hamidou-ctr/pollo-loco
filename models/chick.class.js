class Chick extends MovableObject {
    ...
    hit() {
        ...
        // Play sound indicating the chick is dead
        this.deadChickSound.play();

        // Remove the chick from the world after a delay
        setTimeout(() => {
            this.chickDead = true;
     ...
     */
    animate() {
        // Handle movement if the chick is not dead
        setInterval(() => {
            if (!this.chickDead) {
                this.moveLeft();
            }
        ...
        // Handle animation frames for walking if the chick is not dead
        setInterval(() => {
            if (!this.chickDead) {

...
function init() {
    ...
    // Überprüfen, ob der `isMuted`-Wert im localStorage vorhanden ist
    if (localStorage.getItem('isMuted') !== null) {
        isMuted = (localStorage.getItem('isMuted') === 'true'); // Stelle den Wert wieder her
        applyAudioState(); // Wende den Zustand auf alle Sounds an
    }
}
...
function toggleAudio() {
    ...
    localStorage.setItem('isMuted', isMuted);  // Speichere den Zustand in localStorage
    updateAudioIcon();
}
